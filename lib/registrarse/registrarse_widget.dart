...
class _RegistrarseWidgetState extends State<RegistrarseWidget> {
  ...
  void initState() {
    ...
    _model.txtApellidoPaternoTextController ??= TextEditingController();
    _model.txtApellidoPaternoFocusNode ??= FocusNode();

    _model.txtApellidoMaternoTextController ??= TextEditingController();
    _model.txtApellidoMaternoFocusNode ??= FocusNode();

    _model.txtCorreoTextController ??= TextEditingController();
    _model.txtCorreoFocusNode ??= FocusNode();

    _model.txtContrasennaTextController ??= TextEditingController();
    _model.txtContrasennaFocusNode ??= FocusNode();

    _model.txtConfirmarContrasennaTextController ??= TextEditingController();
    _model.txtConfirmarContrasennaFocusNode ??= FocusNode();
                          ...
                          children: [
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .txtApellidoPaternoTextController,
                                              focusNode: _model
                                                  .txtApellidoPaternoFocusNode,
                                              autofocus: false,
                                              enabled: true,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .txtApellidoMaternoTextController,
                                              focusNode: _model
                                                  .txtApellidoMaternoFocusNode,
                                              autofocus: false,
                                              enabled: true,
                                              obscureText: false,
                                              decoration: InputDecoration(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'Ingreses su correo electronico',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          font: GoogleFonts.inter(
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.txtContrasennaTextController,
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model
                                      .txtConfirmarContrasennaTextController,
                                  focusNode:
                                      _model.txtConfirmarContrasennaFocusNode,
                                  autofocus: false,
                                  enabled: true,
                                  obscureText:
                                      !_model.txtConfirmarContrasennaVisibility,
                                  decoration: InputDecoration(
                                    isDense: true,
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                    ...
                                    suffixIcon: InkWell(
                                      onTap: () async {
                                        safeSetState(() => _model
                                                .txtConfirmarContrasennaVisibility =
                                            !_model
                                                .txtConfirmarContrasennaVisibility);
                                      },
                                      focusNode: FocusNode(skipTraversal: true),
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (_model.txtContrasennaTextController.text !=
                            _model.txtConfirmarContrasennaTextController.text) {
                        ...
                        await UsersRecord.collection
                            ...
                            .update(createUsersRecordData(
                              ...
                              apellidoMaterno:
                                  _model.txtApellidoMaternoTextController.text,
                              apellidoPaterno:
                                  _model.txtApellidoPaternoTextController.text,
                            ));
