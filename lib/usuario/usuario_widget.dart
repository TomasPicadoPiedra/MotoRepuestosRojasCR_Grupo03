...
import '/components/user_detail_page_widget.dart';
                  ...
                  children: [
                    Align(
                      ...
                      child: TabBar(
                        ...
                        indicatorColor: Color(0xFF6B0000),
                        tabs: [
                          Tab(
                            text: 'Consultar',
                          ),
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Builder(
                                      builder: (context) {
                                        if (_model.txtBuscadorTextController
                                                    .text !=
                                                '') {
                                                                  ...
                                                                  await showDialog<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            ...
                                                                            content:
                                                                                Text('ESTA ACCIÓN NO SE DESHACE'),
                                                                            actions: [
                                                                              TextButton(
